(function($) {
	...
	$(window).load(function(){
		...
		var _this    = $('#cherry-chat-dialog'),
			...
			$order_form     = $('.cherry-chat-accordion-item.first-item'),
			$default_form   = $('.cherry-chat-accordion-item.second-item');
